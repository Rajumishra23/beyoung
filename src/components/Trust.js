      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="sm:hidden flex gap-4 justify-between">
          {highlights.map((item, index) => (
            <div
              key={index}
              className="flex-1 bg-white shadow-md rounded-lg border border-gray-200 hover:border-gray-400 transition-transform duration-300 flex flex-col items-center"
            >
              <img
                src={item.image}
                alt={item.title}
